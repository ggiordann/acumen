      ...
      messages: [
        {
          ...
          content: [
            { type: 'text', text: `
                ...
                - Description – a detailed description of the product. At the end include: "Generated by Acumen (acumen.ai)"
                ...
                DO NOT SPECIFY IT IS A JSON WITH THOSE DASHES OR I'LL TERMINATE YOU

            `}, // termination is necessary otherwise it doesn't do it correctly unfortunately :(
...
async function postListing(adData) {
  ...
  await page.getByRole('button', { name: adData.Category || "" }).click();

  // condition: open combobox and select the condition -> nth is the child of the box
  // adi if ts doesn't make sense look @ documentation

  await page.getByRole('combobox', { name: 'Condition' }).locator('div').nth(2).click();
  await page.getByRole('option', { name: adData.Condition || 'Used – good' }).click();
